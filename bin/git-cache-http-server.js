...
Main.getParams = function(req) {
	...
	if(new EReg("^.+\\.googlesource\\.com/.*","").match(repo) && !StringTools.endsWith(repo,".git")) {
		repo += ".git";
	}
	return { repo : repo, auth : Main.parseAuth(req.headers["authorization"]), service : r.matched(4), isInfoRequest : r.matched(3) != null};
};
